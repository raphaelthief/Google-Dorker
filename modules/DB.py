...
def mails(ent, mail):
    ...
    print(f"{Fore.RED}[+] {Fore.YELLOW}Emails Dorks :{Fore.GREEN}")
    print(email_dorks)
...
def torch():
    ...
    print(f"{Fore.RED}[+] {Fore.YELLOW}Tor Ransomwares Links :{Fore.GREEN}")
    print(tor_dorks)
...
def linkedinmedia(ent, mail):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Linkedin Dorks :{Fore.GREEN}")
        print(data)
    else:
        pass
    ...
    if mail is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Email Linkedin Dorks :{Fore.GREEN}")
        print(data)
    else:
        pass
...
def leakedforums(ent, mail):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Breached Forums Dorks :{Fore.GREEN}")
        print(data)
        print(f"{Fore.RED}--> {Fore.GREEN}intext:{ent2} site:crackingx.com OR site:patched.to OR site:breachforums.cx OR site:nulled.to OR site:darkforums.me OR site:doxbin.org OR site:hackforums.net OR site:demonforums.net OR site:blackhatworld.com OR site:instant-hack.to OR site:sinister.ly OR site:pastebin.com\n")
    else:
        pass
    ...
    if mail is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Email Breached Forums Dorks :{Fore.GREEN}")
        print(data)
        print(f"{Fore.RED}--> {Fore.GREEN}intext:{mail} site:crackingx.com OR site:patched.to OR site:breachforums.cx OR site:nulled.to OR site:darkforums.me OR site:doxbin.org OR site:hackforums.net OR site:demonforums.net OR site:blackhatworld.com OR site:instant-hack.to OR site:sinister.ly OR site:pastebin.com\n")
    else:
        pass
...
def filesX(ent, mail):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Files Dorks :{Fore.GREEN}")
        print(data)
    else:
        pass
    ...
    if mail is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Email Files Dorks :{Fore.GREEN}")
        print(data)
        print(f"{Fore.RED}--> {Fore.GREEN}intext:{mail} site:crackingx.com OR site:patched.to OR site:breachforums.cx OR site:nulled.to OR site:darkforums.me OR site:doxbin.org OR site:hackforums.net OR site:demonforums.net OR site:blackhatworld.com OR site:instant-hack.to OR site:sinister.ly\n")
...
def databases(ent):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Databases Dorks :{Fore.GREEN}")
        print(data)
    else:
        pass
...
def configurationX(ent):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Config Dorks :{Fore.GREEN}")
        print(data)
...
def logsX(ent):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Logs-files Dorks :{Fore.GREEN}")
        print(data)
...
def passX(ent, mail):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Passwords Dorks :{Fore.GREEN}")
        print(data)
    else:
        pass
    ...
    if mail is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Email Passwords Dorks :{Fore.GREEN}")
        print(data)
...
def breakit(ent):
    ...
    if ent is not None:
        ...
        print(f"{Fore.RED}[+] {Fore.YELLOW}Entreprise Web-config Dorks :{Fore.GREEN}")
        print(data)
